const boatArray = [
  ...
  },
  {
    ...
    img: 'https://www.thefactsite.com/wp-content/uploads/2020/04/boaty-mcboatface-story.jpg',
    description:
  ...
  },
  {
    id: 6,
    name: 'The ORCA',
    img: 'https://media.comicbook.com/2020/07/jaws-movie-boat-orca-1229808.jpeg?auto=webp',
    description:
  ...
  },
  {
    id: 9,
    name: 'USS Enterprise',
    img: 'https://upload.wikimedia.org/wikipedia/commons/0/0a/USS_Enterprise_%28CVN-65%29_underway_in_the_Atlantic_Ocean_on_14_June_2004_%28040614-N-0119G-020%29.jpg',
    description:
      "The USS Enterprise was a nuclear-powered aircraft carrier that was the world’s first of its kind. It was over 342 meters long, weighed over 90,000 tons, and could accommodate over 5,000 sailors and aviators. It is largely regarded as one of the most important warships in American naval history. The ship was launched in 1960 and played an important role in a number of battles.",
    price: 451300000
  },
  {
    id: 10,
    name: 'RBNS Sabha',
    img: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/RBNS_Sabha_%28FFG_90%29_Bahrain.jpg',
    description:
      "RBNS Sabha (90) (Arabic: ﺱﻡﺏ صبحا) is an Oliver Hazard Perry-class frigate in service with the Royal Bahrain Naval Force. The ship was former United States Navy frigate USS Jack Williams (FFG-24). The frigate is now considered as the lead frigate of the Royal Bahrain Naval Force. On September 13th, 1996, she was transferred to Bahrain as a gift. The frigate was named after a sea fort in Zubarah (located in modern-day Qatar), which historically belonged to the Al Khalifa royal family of Bahrain.",
    price: 0
  }
]

export default boatArray
